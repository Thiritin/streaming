...
class CommandRegistry
{
    ...
    protected function discoverCommands(): void
    {
        ...
        // Aliases are rebuilt from the (possibly cached) metadata, otherwise they would
        // only exist on the request that warmed the cache.
        foreach ($this->commands as $commandName => $data) {
            foreach ($data['metadata']['aliases'] ?? [] as $alias) {
