...
class CommandSystemTest extends TestCase
{
    ...
    public function test_command_feedback_event()
    {
        ...
        // Feedback rides the same per-user private channel as the other chat events.
        $this->assertEquals('private-user.1', $channels[0]->name);
    }
    ...
    public function test_command_suggestions()
    {
        ...
        $user->method('canModerateChat')->willReturn(true);
        $user->method('canBanFromChat')->willReturn(true);
