...
class TimeoutCommandTest extends TestCase
{
    ...
    public function test_admin_can_timeout_user()
    {
        ...
        // The moderator gets private feedback, the target gets a state update,
        // and the chat gets an inline notice.
        Event::assertDispatched(CommandFeedbackEvent::class, 1);
        Event::assertDispatched(ChatUserStateEvent::class);
        Event::assertDispatched(ChatNoticeEvent::class);
    }
    ...
    public function test_cannot_timeout_self()
    {
        ...
        Event::assertDispatched(CommandFeedbackEvent::class, function ($event) {
            return str_contains($event->message, 'cannot moderate this user');
        });
    }
    ...
    public function test_invalid_duration_format()
    {
        ...
        Event::assertDispatched(CommandFeedbackEvent::class, function ($event) {
            return str_contains($event->message, 'Invalid duration');
        });
    }
    ...
    public function test_updating_existing_timeout()
    {
        ...
        $this->assertTrue($updatedTimeout->expires_at->isAfter(now()->addMinutes(30)));
    }
